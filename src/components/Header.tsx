  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        scrolled
          ? "backdrop-blur-xl bg-[#0b0f19]/90 border-b border-white/10 shadow-lg shadow-black/30"
          : "backdrop-blur-md bg-[#0b0f19]/60"
      }`}
    >
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          {[
            ...
            >
              {item.label}
              <span className="absolute -bottom-0.5 left-0 h-px w-0 bg-[#f0483e] transition-all duration-300 group-hover:w-full" />
            </a>
          ))}
        </nav>
